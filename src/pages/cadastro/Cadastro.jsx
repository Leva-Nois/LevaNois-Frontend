            ...
            <div className="cont_login">
              ...
              <div className="cont_forms" ref={contFormsRef}>
                ...
                <div className="cont_form_login" ref={formLoginRef}>
                  ...
                  <button className="btn_sign_up" type="submit" onClick={handleSignUp}>Entrar</button>
                </div>
                <div className="cont_form_sign_up" ref={formSignUpRef}>
                  ...
                  <button className="btn_sign_up" type="submit" onClick={handleSignUp}>Cadastrar</button>
                </div>
              </div>
            </div>
          </div>
